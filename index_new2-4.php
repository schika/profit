...
<form action="http://profitcontent.biz/subscribe.php" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" novalidate="">
   ...
   <img src="images/headline4-2.png">
...
<!--
		   <div class="formPos1">
            ...
            <div class="formPos1">
				<input type="text" value="Телефон" name="MMERGE2" class="formType1 autoclear" id="mce-MMERGE2">
						...
						-->
            <div class="formPos2">
				<input type="email" value="Напиши E-mail" name="EMAIL" class="required email formType1 autoclear" id="mce-EMAIL" required>
            </div>
            <div class="end"></div>
     ...
     <!--        <h4 class="color1">Зачем мы даем Бесплатный заказ на сервисе?</h4> -->
        ...
        <div class="end"></div>
        <a href="#go" class="buttonType2" title="Я же умный, поэтому я запишусь на бесплатный тест сервиса">Я же умный, поэтому я запишусь на Бесплатный тест сервиса. Жми!</a>
        <footer>
 ...
 <p class="pStyle2">Просто Напишите свою почту и получите бесплатный заказ.</p>	  
	   ...
	   <p class="pStyle2"> <a href="#go"  align="center"><b>                         ДА, я уже хочу фирменный Бесплатный заказ текста для сайта</b></a></p> 
		   <ul><br> <br> 
