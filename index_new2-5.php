...
<body class="bgBody2"><div id="last" style="display: none;">Последний заказ забронирован 1 минуту назад.</div>
...
<noscript>
    <div><img src="//mc.yandex.ru/watch/21977746" style="position:absolute; left:-9999px;" alt=""/></div>
</noscript>
<!-- /Yandex.Metrika counter -->

<?php include_once("counter.php"); ?>

<form action="http://profitcontent.biz/subscribe.php" method="post" id="mc-embedded-subscribe-form"
      name="mc-embedded-subscribe-form" class="validate" novalidate="">

    <div class="container">


        <img src="images/headline4-4.png">

        <!--
          <h1>Не думай получить свой бесплатный заказ текста для сайта.</h1>
        <h3>Закрой эту страницу и потеряй его</h3>
        ...
        <div class="whiteBlog1">
            ...
            <!--    <h2>Запишись в список получения <span>бесплатного</span> заказа</h2>   <br><br>	-->
                       ...
                       <div class="formPos1">
                        ...
                        <div class="formPos1">
                            <input type="text" value="Телефон" name="MMERGE2" class="formType1 autoclear" id="mce-MMERGE2">
                                    ...
                                    -->
            <div class="formPos2">
                <input type="email" value="Напиши E-mail" name="EMAIL" class="required email formType1 autoclear"
            ...
            <h5 class="h5Style2">*** Мы против спама!</h5>
        ...
        <p class="pStyle1">Получите Кейс 1.<br>Как мы получили 201 222 целевых клиента-пользователяна сайт потратив $150
        </p>

        <div class="end"></div>
        <a href="#go" class="buttonType2" title="Я же умный, поэтому я запишусь на бесплатный тест сервиса">Я же умный,
            поэтому я запишусь на Бесплатный тест сервиса. Жми!</a>
        <footer>
            <p class="pStyle2"><b>P.s 96.7% </b> гарантия того, что Закрыв эту страницу = потеряешь бесплатный заказ
                НАВСЕГДА. </p>

            <p class="pStyle2"><b>P.s.s </b>НЕ думай о бесплатном заказе который уже твой. Закрой эту страницу ты его
                потеряешь</p>

            <p class="pStyle2">Просто Напишите свою почту и получите бесплатный заказ.</p>

            <p class="pStyle2"><a href="#go" align="center"><b> ДА, я уже хочу фирменный Бесплатный заказ текста для
                        сайта</b></a></p>
            <ul><br> <br>
                <li><a href="politic1.htm">Политика конфиденциальности</a></li>
                <li><a href="politic2.htm">Отказ от ответственности</a></li>
                <li><a href="politic3.htm">Согласие с рассылкой</a></li>
            </ul>
        </footer>
    </div>
...
<noscript>
    <div style="display:inline;">
        <img height="1" width="1" style="border-style:none;" alt=""
             src="//googleads.g.doubleclick.net/pagead/viewthroughconversion/983817261/?value=0&amp;guid=ON&amp;script=0"/>
    </div>
</noscript>
