...
<head>
    ...
    <script>function utmx_section() {
        ...
        (function () {
            var
                k = '75191265-2', d = document, l = d.location, c = d.cookie;
...
<body class="bgBody2" onload="onLoad()">
...
<form action="http://profitcontent.biz/subscribe.php" method="post" id="mc-embedded-subscribe-form"
    ...
    <div class="container">
        ...
        <div class="whiteBlog1">
            ...
            <div class="formPos1">
                <input type="email" value="E-mail" name="EMAIL" class="required email formType1 autoclear"
                       id="mce-EMAIL" required>
            </div>
            <div class="end"></div>
            <input type="submit" value="Записаться" name="subscribe" id="mc-embedded-subscribe" class="buttonType1">
            <h5 class="h5Style1">Мы заплатим вам $2 за 1000 знаков текста</h5>
            <h5 class="h5Style2">*если вам не понравится ваш 1-ый бесплатный текст</h5>
        </div>
        <h4 class="color1">3 Причины почему нужно записаться?</h4>
        ...
        <div class="end"></div>
        <a href="#" class="buttonType2" title="Я же очень умный, поэтому я запишусь на бесплатный тест сервиса">Я же
            очень умный, поэтому я запишусь на бесплатный тест сервиса</a>
        <footer>
            <ul>
