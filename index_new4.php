...
<form action="http://profitcontent.biz/subscribe.php" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" novalidate="">
    ...
    <div class="container">
        <h1>Заказываешь тексты для сайта?</h1>
        <h3>А ТЫ хочешь получить БЕСПЛАТНЫЙ ЗАКАЗ?</h3>
        <div class="whiteBlog1">
             Бесплатный заказ только в честь открытия биржи копирайтинга <br>
            1-ый Бесплатный заказ Получишь Только Ты и еще 199 человек
            <h2>Запишись для получения <span>Бесплатного</span> заказа</h2>
            <span>Бесплатных заказов осталось: <span><?= $num; ?></span></span>
            <div class="formPos">
            ...
            <h5 class="h5Style1">Мы заплатим вам $5 за 1000 знаков текста</h5>
            <h5 class="h5Style2">*если вам не понравится ваш 1-ый бесплатный текст</h5>
        </div>
        <h4>3 Причины почему нужно записаться?</h4>
        <div class="whiteBlog2">
            <div class="top">
        ...
        <div class="end"></div>
        <h4>Зачем мы даем Бесплатный заказ на сервисе?</h4>
        <div class="whiteBlog2">
            <div class="top">
        ...
        <p class="pStyle1">Получите Кейс.<br>Как мы получили 201 222 целевых клиента-пользователяна сайт потратив $150</p>
        <div class="end"></div>
        <a href="#" class="buttonType2" title="Я же очень умный, поэтому я запишусь на бесплатный тест сервиса">Я же очень умный, поэтому я запишусь на бесплатный тест сервиса</a>
        <footer>
            <ul>
